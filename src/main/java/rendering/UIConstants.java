...
public class UIConstants {
    ...
    public static final float LEVEL_UP_BOX_EFFECT_SCALE = 0.7f;
    
    public static final float LEVEL_UP_BOX_ICON_SIZE = 64f;
    public static final float LEVEL_UP_BOX_ICON_Y_FROM_BOTTOM = 75f;
    
    public static final float LEVEL_UP_LEVEL_SQUARE_SIZE = 16f;
    public static final float LEVEL_UP_LEVEL_SQUARE_GAP = 6f;
}